...
def scatter_chart_example(x, y, filename):
    plt.figure(layout="constrained") # a new "current" figure
...
def main():
    ...
    # # challenge!
    # # print out the name of the player who gets the most points per game (ppg) they play
    # # and the their ppg
    ...
    line_chart_example(df.index, df["PTS"], df["MIN"], "figures/line_example.png")

    # # 2. scatter chart
    scatter_chart_example(df.index, df["PTS"], "figures/scatter_example.png")

    # 3. bar chart
    bar_chart_example(class_counts_ser.index, class_counts_ser, "figures/bar_example.png")

    # 4. pie chart
    pie_chart_example(class_counts_ser.index, class_counts_ser, "figures/pie_example.png")

    # 5. histogram chart
    histogram_chart_example(df["PTS"], "figures/hist_example.png")
